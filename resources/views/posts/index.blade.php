...
<body>
    <div class="col-md-8 col-md-offset-2">
        <h2 class="text-center">Master Item</h2>
        <h4 class="text-center">Welcome <strong>{{ Auth::user()->name }}</strong></h4>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <ul>
                    ...
                    <a class="btn btn-danger pull-right" href="{{ url('/logout') }}"
                        ...
                        <tbody>
                            @foreach($posts as $indexKey => $post)
                                <tr class="item{{$post->id}} @if($post->is_published) warning @endif">
                                    ...
                                    <td>
                                        <button class="edit-modal btn btn-warning" data-id="{{$post->id}}" data-title="{{$post->title}}" data-content="{{$post->content}}">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if ((data.errors)) {
                        ...
                        $('#postTable').prepend("<tr class='item" + data.id + "'><td class='col1'>" + data.id + "</td><td>" + data.title + "</td><td>" + data.content + "</td><td><button class='edit-modal btn btn-warning' data-id='" + data.id + "' data-title='" + data.title + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-edit'></span> Update</button> <button class='delete-modal btn btn-danger' data-id='" + data.id + "' data-title='" + data.title + "' data-content='" + data.content + "'><span class='glyphicon glyphicon-trash'></span> Remove</button></td></tr>");
